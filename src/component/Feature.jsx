...
import Featur3 from "../assets/Feature/Feature3.jpg";
import Featur4 from "../assets/Feature/Feature4.jpeg";
import Featur5 from "../assets/Feature/Feature5.jpg";
import Featur6 from "../assets/Feature/Feature6.jpg";
import Featur7 from "../assets/Feature/Feature7.jpg";
import Featur8 from "../assets/Feature/Feature8.jpg";
import Featur9 from "../assets/Feature/Feature9.jpg";
import Featur10 from "../assets/Feature/Feature10.jpg";
        ...
        <section className="py-10 bg-[#e2e2e294]">
            ...
            <div className="my-10">
                <Slider {...settings}>
                    ...
                    <div className="relative group mx-5">
                        <img src={Featur5} alt="Feature5" className="h-[650px] w-[90%] cursor-pointer transform transition-transform duration-500 ease-in-out  group-hover:-scale-x-100" />
                        <div className="absolute inset-x-0 bottom-0 h-0 bg-[rgba(0,0,0,0.5)] w-[90%] group-hover:h-full transition-all duration-500 ease-in-out cursor-pointer"></div>
                        <div className="absolute bottom-14 left-0 px-8">
                            <h3 className="font-suse font-bold text-3xl text-white">Edison Angelo</h3>
                            <p className="font-suse font-normal text-[14px] text-white">Bashundhara R/A</p>
                    ...
                    <div className="relative group mx-5">
                        <img src={Featur6} alt="Feature6" className="h-[650px] w-[90%] cursor-pointer transform transition-transform duration-500 ease-in-out  group-hover:-scale-x-100" />
                        <div className="absolute inset-x-0 bottom-0 h-0 bg-[rgba(0,0,0,0.5)] w-[90%] group-hover:h-full transition-all duration-500 ease-in-out cursor-pointer"></div>
                        <div className="absolute bottom-14 left-0 px-8">
                            <h3 className="font-suse font-bold text-3xl text-white">Edison Angelo</h3>
                            <p className="font-suse font-normal text-[14px] text-white">Bashundhara R/A</p>
                    ...
                    <div className="relative group mx-5">
                        <img src={Featur7} alt="Feature7" className="h-[650px] w-[90%] cursor-pointer transform transition-transform duration-500 ease-in-out  group-hover:-scale-x-100" />
                        <div className="absolute inset-x-0 bottom-0 h-0 bg-[rgba(0,0,0,0.5)] w-[90%] group-hover:h-full transition-all duration-500 ease-in-out cursor-pointer"></div>
                        <div className="absolute bottom-14 left-0 px-8">
                            <h3 className="font-suse font-bold text-3xl text-white">Edison Angelo</h3>
                            <p className="font-suse font-normal text-[14px] text-white">Bashundhara R/A</p>
                    ...
                    <div className="relative group mx-5">
                        <img src={Featur8} alt="Feature8" className="h-[650px] w-[90%] cursor-pointer transform transition-transform duration-500 ease-in-out  group-hover:-scale-x-100" />
                        <div className="absolute inset-x-0 bottom-0 h-0 bg-[rgba(0,0,0,0.5)] w-[90%] group-hover:h-full transition-all duration-500 ease-in-out cursor-pointer"></div>
                        <div className="absolute bottom-14 left-0 px-8">
                            <h3 className="font-suse font-bold text-3xl text-white">Edison Angelo</h3>
                            <p className="font-suse font-normal text-[14px] text-white">Bashundhara R/A</p>
                    ...
                    <div className="relative group mx-5">
                        <img src={Featur9} alt="Feature9" className="h-[650px] w-[90%] cursor-pointer transform transition-transform duration-500 ease-in-out  group-hover:-scale-x-100" />
                        <div className="absolute inset-x-0 bottom-0 h-0 bg-[rgba(0,0,0,0.5)] w-[90%] group-hover:h-full transition-all duration-500 ease-in-out cursor-pointer"></div>
                        <div className="absolute bottom-14 left-0 px-8">
                            <h3 className="font-suse font-bold text-3xl text-white">Edison Angelo</h3>
                            <p className="font-suse font-normal text-[14px] text-white">Bashundhara R/A</p>
                    ...
                    <div className="relative group mx-5">
                        <img src={Featur10} alt="Feature10" className="h-[650px] w-[90%] cursor-pointer transform transition-transform duration-500 ease-in-out  group-hover:-scale-x-100" />
                        <div className="absolute inset-x-0 bottom-0 h-0 bg-[rgba(0,0,0,0.5)] w-[90%] group-hover:h-full transition-all duration-500 ease-in-out cursor-pointer"></div>
                        <div className="absolute bottom-14 left-0 px-8">
                            <h3 className="font-suse font-bold text-3xl text-white">Edison Angelo</h3>
                            <p className="font-suse font-normal text-[14px] text-white">Bashundhara R/A</p>
